      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-sm text-gray-300">Verified Providers</span>
              </div>
              <div className="flex items-center">
                <StarIconSolid className="h-5 w-5 text-yellow-400 mr-2" />
                <span className="text-sm text-gray-300">4.8★ Average Rating</span>
              </div>
              <div className="flex items-center">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/services?type=electrician" className="text-gray-300 hover:text-white transition-colors">
                  Electrician
                </Link>
              </li>
              <li>
                <Link href="/services?type=plumber" className="text-gray-300 hover:text-white transition-colors">
                  Plumber
                </Link>
              </li>
              <li>
                <Link href="/services?type=wedding-services" className="text-gray-300 hover:text-white transition-colors">
                  Wedding Services
                </Link>
              </li>
              <li>
                <Link href="/services?type=beauty" className="text-gray-300 hover:text-white transition-colors">
                  Beauty & Wellness
                </Link>
              </li>
              <li>
                <Link href="/services?type=ro-ac" className="text-gray-300 hover:text-white transition-colors">
                  RO & AC Services
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                <PhoneIcon className="h-5 w-5 text-green-400 mr-3 flex-shrink-0" />
